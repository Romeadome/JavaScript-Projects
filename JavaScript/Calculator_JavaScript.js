...
const Calculator = {
    ...
    //this will hold the operatorm we ser it to null for now
    operator: null,
};

//this modifies values each time a button is vlicked
function Input_Digit(digit) {
    const {Display_Value, Wait_Second_Operand} = Calculator;
    //we are checking to see if Wait_Second_Operand is tue and set
...
function Handle_Operator(Next_Operator) {
    ...
    //checks if an operator alread exists and if Wait_Second_Operand is true,
